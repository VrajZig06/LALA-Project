...
class SuccessMessage:
    ...
    ALREADY_SENT_RESET_PASSWORD_LINK = 'Already Sent reset password Link, Please Check Your Inbox'
...
class ErrorMessage:
    ...
    FORGOT_PASSWORD_MSG = "If an account exists for this email,we've sent password reset instructions."
...
class LoggerMessage:
    ...
    API_VERIFY_OTP_ATTEMPT = "API verify-otp: OTP verification attempt for user_id='{user_id}'"
    API_VERIFY_OTP_SUCCESS = "API verify-otp: OTP verification successful for user_id='{user_id}'"
    API_RESET_PASSWORD_REQUEST = "API reset-password: password reset request for user_id='{user_id}'"
    API_RESET_PASSWORD_SUCCESS = "API reset-password: password reset successful for user_id='{user_id}'"
    ...
    API_FORGOT_PASSWORD_COMPLETED = "API forgot-password: request completed for email='{email}'"
    API_VALIDATE_PASSWORD_REQUEST = "API validate-password: password validation request received"
    API_VALIDATE_PASSWORD_SUCCESS = "API validate-password: password reset validation successful"
    API_REFRESH_TOKEN_REQUEST = "API refresh-token: refresh_token request recieved"
    API_REFRESH_TOKEN_SUCCESS = "API refresh-token: refresh_token generates access token successfully"

    # User Service Logs
    REGISTER_USER_START = "register_user: Start registration process for email='{email}'"
    REGISTER_USER_EXISTS_VERIFIED = "register_user: User already exists and is verified for email='{email}'"
    REGISTER_USER_RESEND_OTP = "register_user: Resending verification OTP to existing unverified user email='{email}'"
    REGISTER_USER_RESEND_SUCCESS = "register_user: Verification email resent successfully to email='{email}'"
    REGISTER_USER_NEW_SEND = "register_user: Sending verification email for new user email='{email}'"
    REGISTER_USER_ROLE_NOT_FOUND = "register_user: Default role '{role_name}' not found in database"
    ...
    USER_LOGIN_USER_NOT_FOUND = "user_login: Login failed: User not found or deleted for email='{email}'"
    USER_LOGIN_PENDING_VERIFICATION = "user_login: Login failed: Email verification pending or account inactive for email='{email}'"
    USER_LOGIN_INCORRECT_PASSWORD = "user_login: Login failed: Incorrect password for email='{email}'"
    USER_LOGIN_SUCCESS = "user_login: Login successful for email='{email}', user_id='{user_id}'"
    USER_LOGIN_ERROR = "user_login: Unexpected error during login flow: {error}"

    RESET_PASSWORD_START = "reset_password: Initiating password reset for user_id='{user_id}'"
    RESET_PASSWORD_USER_NOT_FOUND = "reset_password: User not found or invalid status for user_id='{user_id}'"
    ...
    RESET_PASSWORD_SUCCESS = "reset_password: Password reset successful for user_id='{user_id}'"
    RESET_PASSWORD_ERROR = "reset_password: Unexpected error during password reset: {error}"

    GOOGLE_AUTH_START = "google_auth: Google SSO token verification started"
    GOOGLE_AUTH_NO_EMAIL = "google_auth: Google token decoded successfully but did not contain email"
    ...
    GOOGLE_AUTH_PROVISION_NEW = "google_auth: No existing user found. Provisioning new user for email='{email}'"
    GOOGLE_AUTH_ROLE_NOT_FOUND = "google_auth: Default role '{role_name}' not found in database"
    GOOGLE_AUTH_SUCCESS = "google_auth: Google SSO authentication successful for email='{email}', user_id='{user_id}'"
    GOOGLE_AUTH_ERROR = "google_auth: Unexpected error during Google authentication: {error}"

    FORGOT_PASSWORD_START = "forgot_password: Password recovery requested for email='{email}'"
    ...
    FORGOT_PASSWORD_LINK_GENERATED = "forgot_password: Password reset link generated and queued for email='{email}'"
    FORGOT_PASSWORD_ERROR = "forgot_password: Unexpected error during forgot password flow: {error}"

    VALIDATE_FORGOT_PASSWORD_START = "validate_forgot_password: Validating forgot password recovery token"
